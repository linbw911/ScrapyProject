...
class HsmySpiderMiddleware(object):
...
class ActionMiddleware(object):
    ...
    def process_request(self, request, spider):
        if request.url == spider.start_urls[0]:
            ...
            driver.find_element_by_id('tabSti').click()
            driver.implicitly_wait(10)
            driver.find_element_by_id('stiMonth').click()
            driver.find_element_by_css_selector('input[onclick="searchSTI();"]').click()
